...
exports.BrentCrudeOilSource = exports.SPYSource = exports.VIXSource = exports.YahooFinanceSource = void 0;
const axios_1 = __importDefault(require("axios"));
class YahooFinanceSource {
    constructor(symbol, metric = "price") {
        this.symbol = symbol;
        this.metric = metric;
    ...
    async fetch() {
        try {
            const response = await axios_1.default.get(`https://query1.finance.yahoo.com/v8/finance/chart/${this.symbol}`, {
                params: {
                    interval: "1d",
                    range: "1d",
                },
            ...
            console.log(`[YahooFinanceSource] Successfully fetched ${this.metric} for ${this.symbol}: ${value} at ${timestamp.toISOString()}`);
            return {
                name: this.key,
                timestamp,
                value,
...
exports.YahooFinanceSource = YahooFinanceSource;
class VIXSource extends YahooFinanceSource {
    constructor() {
        super("^VIX", "price");
        this.key = "vix_level";
    }
}
exports.VIXSource = VIXSource;
class SPYSource extends YahooFinanceSource {
    constructor() {
        super("SPY", "price");
        this.key = "spy_price";
    }
}
exports.SPYSource = SPYSource;
class BrentCrudeOilSource {
    constructor() {
...
exports.BrentCrudeOilSource = BrentCrudeOilSource;
BrentCrudeOilSource.BRENT_SYMBOLS = ["BZ=F", "BZT=F", "^SGICBRB"];
